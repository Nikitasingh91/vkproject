    ...
    <x-content-div heading="Manage Blog">
        <x-card-element header="Add Blog Image">
            <x-form-element method="POST" enctype="multipart/form-data" id="submitForm" action="javascript:">
                ...
                <x-input-with-label-element id="title" label="Blog title" name="title" required>
                ...
                <x-input-with-label-element id="blog_category" label="Blog Category" name="blog_category">
                </x-input-with-label-element>
                <x-input-with-label-element id="blog_date" label="Blog Date" name="blog_date" type="date" required>
                </x-input-with-label-element>
                <x-input-with-label-element id="facebook_link" label="Facebook Link" name="facebook_link">
                </x-input-with-label-element>
                <x-input-with-label-element id="instagram_link" label="Instagram Link" name="instagram_link">
                </x-input-with-label-element>
                <x-input-with-label-element id="twitter_link" label="Twitter Link" name="twitter_link">
                </x-input-with-label-element>
                <x-input-with-label-element id="youtube_link" label="Youtube Link" name="youtube_link">
                </x-input-with-label-element>
